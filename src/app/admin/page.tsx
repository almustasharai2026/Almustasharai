...
import { 
  ...
  FileText, Download, TrendingUp, Bell, Terminal, CheckCircle, ChevronLeft, Menu
} from "lucide-react";
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden flex" dir="rtl">
      ...
      <AnimatePresence mode="wait">
        {isSidebarOpen && (
          <motion.div initial={{ width: 0, opacity: 0 }} animate={{ width: 288, opacity: 1 }} exit={{ width: 0, opacity: 0 }} className="hidden lg:block relative z-50">
            <SovereignSidebar activeId="dash" />
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <header className="h-20 bg-black/40 backdrop-blur-3xl border-b border-white/5 flex items-center justify-between px-10 z-40 shadow-2xl relative">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-black bg-gradient-to-r from-primary to-amber-200 bg-clip-text text-transparent">Supreme Command hub</h1>
            </div>
          </div>
          
          <div className="flex items-center gap-4">
            <div className="bg-emerald-500/10 text-emerald-500 px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border border-emerald-500/20 flex items-center gap-3">
